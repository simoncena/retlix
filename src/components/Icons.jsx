...
// Inline SVG icons (Lucide set, MIT). Stroke uses currentColor so each icon
// inherits the button's text color; size is set per-use, defaulting to 22px.
const PATHS = {
  ...
  back10: <><path d="M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8" /><path d="M3 3v5h5" /></>,
  forward10: <><path d="M21 12a9 9 0 1 1-9-9 9.75 9.75 0 0 1 6.74 2.74L21 8" /><path d="M21 3v5h-5" /></>,
